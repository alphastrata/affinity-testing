...
CSV_FILE = 'avx512-math-stats.csv'
...
def plot_throughput(csv_path):
    ...
    if not os.path.exists(csv_path):
        ...
        print("Please run the benchmark first: ./target/release/avx512-math --output avx512-math-stats.csv")
        return
    ...
    ax.set_title('AVX512 Math Throughput per Core')
    ax.grid(True)
    ax.set_xticks(df['core_id'])
    
    output_path = 'avx512-math-throughput.png'
