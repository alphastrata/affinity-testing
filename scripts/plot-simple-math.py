...
CSV_FILE = 'simple-math-stats.csv'
...
def plot_throughput(csv_path):
    ...
    if not os.path.exists(csv_path):
        ...
        print("Please run the benchmark first: ./target/release/simple-math --output simple-math-stats.csv")
        return
    ...
    ax.set_title('Simple Math Throughput per Core')
    ax.grid(True)
    ax.set_xticks(df['core_id'])
    
    output_path = 'simple-math-throughput.png'
