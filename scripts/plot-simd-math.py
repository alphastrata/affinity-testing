...
def plot_throughput(csv_path):
    ...
    if not os.path.exists(csv_path):
        ...
        print("Please run the benchmark first: ./target/release/simd-math --output simd-math-stats.csv")
        return
    ...
    ax.set_title('SIMD Math Throughput per Core')
    ax.grid(True)
    ax.set_xticks(df['core_id'])
    
    output_path = 'simd-math-throughput.png'
