...
def plot_throughput(csv_path):
    ...
    if not os.path.exists(csv_path):
        ...
        print(
            "Please run the benchmark first: ./target/release/BENCHMARK --output TEMPLATE-stats.csv"
        )
        return
    ...
    ax1.set_title("BENCHMARK_NAME Throughput per Core")
    ...
    plt.tight_layout()
    output_path = "BENCHMARK_NAME-throughput.png"
